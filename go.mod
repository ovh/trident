...
require (
	...
	golang.org/x/crypto v0.50.0 // github.com/golang/crypto
	golang.org/x/net v0.53.0 // github.com/golang/net
	golang.org/x/oauth2 v0.35.0 // github.com/golang/oauth2
	golang.org/x/sync v0.20.0
	golang.org/x/sys v0.43.0 // github.com/golang/sys
	golang.org/x/text v0.36.0 // github.com/golang/text
